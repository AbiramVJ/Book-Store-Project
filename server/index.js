...
=========================================================================================
  METHOD        POST
  route         http://localhost:3001/allmovie/add-book
  Description   Add the new user
*/

app.post("/allmovie/add-book", async (request, respons) => {
  const addBook = await MovieModel.create(request.body);
  console.log(addBook);
  return respons.json({bookAdded: addBook,message: "book was added"});
